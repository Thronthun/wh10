...
class Test extends StatelessWidget {
  ...
  final List<Insta> InstaList = [
    Insta(imguser: 'assets/images/cat1.jpg', img: 'assets/images/cat.jpg',
        userpost: 'Cat', comments: [Comments(user: 'koko', comment: "i love you"),Comments(user: 'yoyo', comment: 'so cute!!!')],
        caption: "Cat lover"),
    Insta(imguser: 'assets/images/dog1.jpg', img: 'assets/images/dog2.jpg',
        userpost: 'Dog',comments: [Comments(user: 'mumu', comment: 'You are so cute!!'),Comments(user: 'nunu', comment: '♥♥♥♥')],
        caption: 'Dog lover'),
   ];
